...
omega_c_nmp = 0.02;                                              % Desired cross-over frequency (nmp) [rad/sec]
...
% g_11(s)w_11(s) + g_12(s)w_12(s) = 0; HINT: w_11(s) = w_22(s) = 1
...
alpha_nmp = 1.1;                           % According to hint
...
y = yout.Data(:,1);
figure;
plot(yout.Time(t), y(t), "LineWidth", 1.5)

stepinfo(y(t), yout.Time(t))
